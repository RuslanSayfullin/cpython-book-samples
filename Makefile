...
abs_srcdir=	/home/rusl4n/Documents/projects/cpython-book-samples
abs_builddir=	/home/rusl4n/Documents/projects/cpython-book-samples
...
AR=		ar
READELF=	readelf
SOABI=		cpython-39d-x86_64-linux-gnu
...
SHLIB_SUFFIX=	.so
EXT_SUFFIX=	.cpython-39d-x86_64-linux-gnu.so
...
# This goes into $(exec_prefix)
LIBPL=		$(prefix)/lib/python3.9/config-$(VERSION)$(ABIFLAGS)-x86_64-linux-gnu
